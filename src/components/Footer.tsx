          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <nav className="flex flex-col space-y-2">
                <button onClick={scrollToTop} className="text-background/80 hover:text-background transition-colors text-left">
                  Home
                </button>
                <button onClick={() => scrollToSection("services")} className="text-background/80 hover:text-background transition-colors text-left">
                  Services
                </button>
                <button onClick={() => scrollToSection("reviews")} className="text-background/80 hover:text-background transition-colors text-left">
                  Reviews
                </button>
                <button onClick={() => scrollToSection("contact")} className="text-background/80 hover:text-background transition-colors text-left">
                  Contact
                </button>
              </nav>
            </div>
